# Azure VNet & NSG Communication Lab

This project demonstrates **Azure Virtual Network (VNet) design and Network Security Group (NSG) configuration**
to control traffic between subnets, aligned with **AZ-104 (Microsoft Azure Administrator)** objectives.
...
![Resullt](HTTP_Result_from_linux_to_Windows.png)
